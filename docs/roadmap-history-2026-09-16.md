# Historical Ariadna Roadmap — preserved 2026-09-16

Historical snapshot, not current scheduling guidance. Priorities and next-step
instructions below are superseded by `openspec/ROADMAP.md` at the repository
root. Evidence and unresolved gates remain valid within their stated scope.
Repository-relative paths below retain their original meaning.
...
The user temporarily paused M3 to deliver the [visible prototype](../openspec/PROTOTYPE.md).
...
[Ariadna product vision](../openspec/VISION.md). The broader goal is an open specification,
