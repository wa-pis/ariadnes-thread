...
| D4 — Research-only fixed-seed experiment | Reference evidence retained; D4.5 open | One live experiment completed six arcs in 20.10 s but failed numerical agreement (1751.29 m arrival difference) and missed the target. See [Decision 0079](../docs/decisions/0079-research-reference.md). No continuous-safety or strict-M3 completion claim. |
